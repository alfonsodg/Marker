            ...
            MarkerMermaidMode   mermaid_mode)
{
  ...
  switch(mermaid_mode)
  {
    case MERMAID_OFF:
      ...
      break;
    default:
      mermaid_render = g_strdup("<script>mermaid.initialize({startOnLoad:true, useMaxWidth:true, flowchart:{useMaxWidth:true,padding:15,nodeSpacing:30,rankSpacing:40}, sequence:{useMaxWidth:true}, er:{useMaxWidth:true}, journey:{useMaxWidth:true}, gantt:{useMaxWidth:true}, pie:{useMaxWidth:true}, mindmap:{useMaxWidth:true}});</script>");
      break;
  }
